      ...
      versions: [
        {
          ...
          additionalPrinterColumns: [
            ...
            },
            {
              ...
              description: 'Storage type (shared/dedicated)',
              priority: 0,
            },
            {
              name: 'Phase',
            ...
            },
            {
              name: 'Compute',
              type: 'string',
              jsonPath: '.status.userInitialized',
              description: 'Compute state (true=live, false=gated)',
              priority: 0,
            },
            {
              name: 'Migration',
            ...
            },
            {
              name: 'Containers',
              type: 'integer',
              jsonPath: '.status.containerCount',
              description: 'Number of containers in Pod',
              priority: 1,
            },
            {
              name: 'Spec-Hash',
              type: 'string',
              jsonPath: '.status.specHash',
              description: 'Spec hash for change detection',
              priority: 1,
            },
          ],
          schema: {
              ...
              properties: {
                ...
                status: {
                  ...
                  properties: {
                    ...
                    storageType: {
                      type: 'string',
                      description: 'Current storage type (shared/dedicated), mirrors Pod annotation',
                      enum: ['shared', 'dedicated'],
                    },
                    userInitialized: {
                      type: 'string',
                      description: 'Whether user has been initialized (true/false), mirrors Pod annotation',
                    },
                    migrationPhase: {
                      type: 'string',
                      description: 'Migration phase (pending/in-progress/complete/n-a), mirrors Pod annotation',
                    },
                    specHash: {
                      type: 'string',
                      description: 'Hash of inputs that drove last Pod render',
                    },
                    containerCount: {
                      type: 'integer',
                      description: 'Number of containers in rendered Pod',
                    },
                  },
                },
              },
