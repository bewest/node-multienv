...
const handleStoragePhase = require('./webhook/tenant-phases/storage');
const handleMigrationPhase = require('./webhook/tenant-phases/migration');
const handleResourcesPhase = require('./webhook/tenant-phases/resources');
